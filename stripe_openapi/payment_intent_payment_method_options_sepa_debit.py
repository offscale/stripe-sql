...
class Payment_Intent_Payment_Method_Options_Sepa_Debit(Base):
    ...
    mandate_options = Column(PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit, nullable=True)
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Intent_Payment_Method_Options_Sepa_Debit(mandate_options={mandate_options!r}, setup_future_usage={setup_future_usage!r}, id={id!r})'.format(mandate_options=self.mandate_options, setup_future_usage=self.setup_future_usage, id=self.id)
