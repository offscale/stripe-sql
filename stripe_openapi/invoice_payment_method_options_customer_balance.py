...
class Invoice_Payment_Method_Options_Customer_Balance(Base):
    ...
    bank_transfer = Column(InvoicePaymentMethodOptionsCustomerBalanceBankTransfer, nullable=True)
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Invoice_Payment_Method_Options_Customer_Balance(bank_transfer={bank_transfer!r}, funding_type={funding_type!r}, id={id!r})'.format(bank_transfer=self.bank_transfer, funding_type=self.funding_type, id=self.id)
