...
class Payment_Method_Details_Acss_Debit(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "Payment_Method_Details_Acss_Debit(bank_name={bank_name!r}, fingerprint={fingerprint!r}, institution_number={institution_number!r}, last4={last4!r}, mandate={mandate!r}, transit_number={transit_number!r})".format(
