...
class Payment_Method_Au_Becs_Debit(Base):
    ...
    bsb_number = Column(String, comment='Six-digit number identifying bank and branch associated with this bank account', nullable=True)
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Method_Au_Becs_Debit(bsb_number={bsb_number!r}, fingerprint={fingerprint!r}, last4={last4!r}, id={id!r})'.format(bsb_number=self.bsb_number, fingerprint=self.fingerprint, last4=self.last4, id=self.id)
