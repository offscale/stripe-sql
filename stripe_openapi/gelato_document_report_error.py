...
class Gelato_Document_Report_Error(Base):
    __tablename__ = 'gelato_document_report_error'
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Gelato_Document_Report_Error(code={code!r}, reason={reason!r}, id={id!r})'.format(code=self.code, reason=self.reason, id=self.id)
__all__ = ['gelato_document_report_error']