...
class Quotes_Resource_Total_Details_Resource_Breakdown(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Quotes_Resource_Total_Details_Resource_Breakdown(discounts={discounts!r}, taxes={taxes!r}, id={id!r})'.format(discounts=self.discounts, taxes=self.taxes, id=self.id)
