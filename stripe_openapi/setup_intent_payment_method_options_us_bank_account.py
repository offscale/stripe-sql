...
class Setup_Intent_Payment_Method_Options_Us_Bank_Account(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Setup_Intent_Payment_Method_Options_Us_Bank_Account(financial_connections={financial_connections!r}, verification_method={verification_method!r}, id={id!r})'.format(financial_connections=self.financial_connections, verification_method=self.verification_method, id=self.id)
