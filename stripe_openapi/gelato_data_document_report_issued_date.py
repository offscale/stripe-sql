...
class Gelato_Data_Document_Report_Issued_Date(Base):
    """
    Point in Time
        """
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Gelato_Data_Document_Report_Issued_Date(day={day!r}, month={month!r}, year={year!r}, id={id!r})'.format(day=self.day, month=self.month, year=self.year, id=self.id)
