...
InboundTransfersPaymentMethodDetailsUsBankAccount.Json = Table(
    "inbound_transfers_payment_method_details_us_bank_account.json",
    metadata,
    Column(
        "account_holder_type",
        String,
    ...
    Column(
        "network", String, comment="The US bank account network used to debit funds"
    ),
    Column(
        "routing_number",
        String,
...
__all__ = ["inbound_transfers_payment_method_details_us_bank_account.json"]
