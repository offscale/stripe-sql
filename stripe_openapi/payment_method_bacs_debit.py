...
class Payment_Method_Bacs_Debit(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Method_Bacs_Debit(fingerprint={fingerprint!r}, last4={last4!r}, sort_code={sort_code!r}, id={id!r})'.format(fingerprint=self.fingerprint, last4=self.last4, sort_code=self.sort_code, id=self.id)
