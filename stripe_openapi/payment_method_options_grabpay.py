...
class Payment_Method_Options_Grabpay(Base):
    __tablename__ = 'payment_method_options_grabpay'
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Method_Options_Grabpay(setup_future_usage={setup_future_usage!r}, id={id!r})'.format(setup_future_usage=self.setup_future_usage, id=self.id)
__all__ = ['payment_method_options_grabpay']