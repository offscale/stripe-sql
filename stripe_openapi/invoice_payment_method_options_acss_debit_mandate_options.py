...
class Invoice_Payment_Method_Options_Acss_Debit_Mandate_Options(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Invoice_Payment_Method_Options_Acss_Debit_Mandate_Options(transaction_type={transaction_type!r}, id={id!r})'.format(transaction_type=self.transaction_type, id=self.id)
