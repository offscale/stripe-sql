...
from stripe_openapi.setup_intent_next_action import SetupIntentNextAction
from stripe_openapi.setup_intent_payment_method_options import (
...
class SetupIntent(Base):
    ...
    customer = Column(
        Customer,
        comment="[[FK(DeletedCustomer)]] ID of the Customer this SetupIntent belongs to, if one exists.\n\nIf present, the SetupIntent's payment method will be attached to the Customer on successful setup. Payment methods attached to other Customers cannot be used with this SetupIntent",
        nullable=True,
    )
    description = Column(
        String,
    ...
    last_setup_error = Column(
        ApiErrors,
        comment="[[FK(ApiErrors)]] The error encountered in the previous SetupIntent confirmation",
        nullable=True,
    )
    latest_attempt = Column(
        SetupAttempt,
        comment="[[FK(SetupAttempt)]] The most recent SetupAttempt for this SetupIntent",
        nullable=True,
    )
    livemode = Column(
        Boolean,
    ...
    next_action = Column(
        ...
        comment="[[FK(SetupIntentNextAction)]] If present, this property tells you what actions you need to take in order for your customer to continue payment setup",
        nullable=True,
    )
    object = Column(
        String,
    ...
    payment_method = Column(
        PaymentMethod,
        comment="[[FK(PaymentMethod)]] ID of the payment method used with this SetupIntent",
        nullable=True,
    )
    payment_method_options = Column(
        SetupIntentPaymentMethodOptions,
        comment="[[FK(SetupIntentPaymentMethodOptions)]] Payment-method-specific configuration for this SetupIntent",
        nullable=True,
    )
