...
class Deleted_Application(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Deleted_Application(deleted={deleted!r}, id={id!r}, name={name!r}, object={object!r})'.format(deleted=self.deleted, id=self.id, name=self.name, object=self.object)
