...
class Payment_Method_Options_Customer_Balance_Bank_Transfer(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Method_Options_Customer_Balance_Bank_Transfer(eu_bank_transfer={eu_bank_transfer!r}, requested_address_types={requested_address_types!r}, type={type!r}, id={id!r})'.format(eu_bank_transfer=self.eu_bank_transfer, requested_address_types=self.requested_address_types, type=self.type, id=self.id)
