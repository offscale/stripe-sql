...
class Outbound_Payments_Payment_Method_Details_Financial_Account(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Outbound_Payments_Payment_Method_Details_Financial_Account(id={id!r}, network={network!r})'.format(id=self.id, network=self.network)
