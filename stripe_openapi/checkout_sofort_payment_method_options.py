...
class Checkout_Sofort_Payment_Method_Options(Base):
    __tablename__ = 'checkout_sofort_payment_method_options'
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Checkout_Sofort_Payment_Method_Options(setup_future_usage={setup_future_usage!r}, id={id!r})'.format(setup_future_usage=self.setup_future_usage, id=self.id)
__all__ = ['checkout_sofort_payment_method_options']