...
class Issuing_Cardholder_Authorization_Controls(Base):
    ...
    spending_limits = Column(list, comment="Limit spending with amount-based rules that apply across this cardholder's cards", nullable=True)
    spending_limits_currency = Column(String, comment='Currency of the amounts within `spending_limits`', nullable=True)
