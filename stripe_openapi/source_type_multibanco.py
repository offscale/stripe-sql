...
class SourceTypeMultibanco(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "SourceTypeMultibanco(entity={entity!r}, reference={reference!r}, refund_account_holder_address_city={refund_account_holder_address_city!r}, refund_account_holder_address_country={refund_account_holder_address_country!r}, refund_account_holder_address_line1={refund_account_holder_address_line1!r}, refund_account_holder_address_line2={refund_account_holder_address_line2!r}, refund_account_holder_address_postal_code={refund_account_holder_address_postal_code!r}, refund_account_holder_address_state={refund_account_holder_address_state!r}, refund_account_holder_name={refund_account_holder_name!r}, refund_iban={refund_iban!r})".format(
            entity=self.entity,
