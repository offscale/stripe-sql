...
class Source_Transaction_Chf_Credit_Transfer_Data(Base):
    ...
    sender_address_country = Column(String, comment="Sender's country address", nullable=True)
    sender_address_line1 = Column(String, comment="Sender's line 1 address", nullable=True)
