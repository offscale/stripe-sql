...
class Checkout_Paynow_Payment_Method_Options(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Checkout_Paynow_Payment_Method_Options(setup_future_usage={setup_future_usage!r}, id={id!r})'.format(setup_future_usage=self.setup_future_usage, id=self.id)
