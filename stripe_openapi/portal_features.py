...
class Portal_Features(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Portal_Features(customer_update={customer_update!r}, invoice_history={invoice_history!r}, payment_method_update={payment_method_update!r}, subscription_cancel={subscription_cancel!r}, subscription_pause={subscription_pause!r}, subscription_update={subscription_update!r}, id={id!r})'.format(customer_update=self.customer_update, invoice_history=self.invoice_history, payment_method_update=self.payment_method_update, subscription_cancel=self.subscription_cancel, subscription_pause=self.subscription_pause, subscription_update=self.subscription_update, id=self.id)
