...
class Funding_Instructions(Base):
    ...
    funding_type = Column(String, comment='The `funding_type` of the returned instructions')
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Funding_Instructions(bank_transfer={bank_transfer!r}, currency={currency!r}, funding_type={funding_type!r}, livemode={livemode!r}, object={object!r}, id={id!r})'.format(bank_transfer=self.bank_transfer, currency=self.currency, funding_type=self.funding_type, livemode=self.livemode, object=self.object, id=self.id)
