...
CheckoutCustomerBalancePaymentMethodOptions.Json = Table(
    "checkout_customer_balance_payment_method_options.json",
    metadata,
    Column(
        "bank_transfer",
        CheckoutCustomerBalanceBankTransferPaymentMethodOptions,
        ForeignKey("CheckoutCustomerBalanceBankTransferPaymentMethodOptions"),
        nullable=True,
    ),
    Column(
        "funding_type",
...
__all__ = ["checkout_customer_balance_payment_method_options.json"]
