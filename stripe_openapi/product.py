...
class Product(Base):
    ...
    active = Column(
        Boolean, comment="Whether the product is currently available for purchase"
    )
    attributes = Column(
        ARRAY(String),
    ...
    name = Column(
        String, comment="The product's name, meant to be displayable to the customer"
    )
    object = Column(
        String,
