...
class Payment_Method_Sepa_Debit(Base):
    ...
    generated_from = Column(SepaDebitGeneratedFrom, comment='Information about the object that generated this PaymentMethod', nullable=True)
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Method_Sepa_Debit(bank_code={bank_code!r}, branch_code={branch_code!r}, country={country!r}, fingerprint={fingerprint!r}, generated_from={generated_from!r}, last4={last4!r}, id={id!r})'.format(bank_code=self.bank_code, branch_code=self.branch_code, country=self.country, fingerprint=self.fingerprint, generated_from=self.generated_from, last4=self.last4, id=self.id)
