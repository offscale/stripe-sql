...
class PaymentIntentNextActionPaynowDisplayQrCode(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "PaymentIntentNextActionPaynowDisplayQrCode(data={data!r}, hosted_instructions_url={hosted_instructions_url!r}, image_url_png={image_url_png!r}, image_url_svg={image_url_svg!r}, id={id!r})".format(
            data=self.data,
