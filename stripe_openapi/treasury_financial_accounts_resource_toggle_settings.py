...
TreasuryFinancialAccountsResourceToggleSettings.Json = Table(
    "treasury_financial_accounts_resource_toggle_settings.json",
    metadata,
    Column(
        "requested",
        Boolean,
...
__all__ = ["treasury_financial_accounts_resource_toggle_settings.json"]
