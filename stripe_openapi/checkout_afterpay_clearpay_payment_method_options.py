...
class Checkout_Afterpay_Clearpay_Payment_Method_Options(Base):
    __tablename__ = 'checkout_afterpay_clearpay_payment_method_options'
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Checkout_Afterpay_Clearpay_Payment_Method_Options(setup_future_usage={setup_future_usage!r}, id={id!r})'.format(setup_future_usage=self.setup_future_usage, id=self.id)
__all__ = ['checkout_afterpay_clearpay_payment_method_options']