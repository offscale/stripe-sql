...
class File(Base):
    ...
    title = Column(
        String, comment="A user friendly title for the document", nullable=True
    )
    type = Column(
        String,
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "File(created={created!r}, expires_at={expires_at!r}, filename={filename!r}, id={id!r}, links={links!r}, object={object!r}, purpose={purpose!r}, size={size!r}, title={title!r}, type={type!r}, url={url!r})".format(
