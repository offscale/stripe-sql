...
class Treasury_Transactions_Resource_Flow_Details(Base):
    ...
    type = Column(String, comment='Type of the flow that created the Transaction. Set to the same value as `flow_type`')
