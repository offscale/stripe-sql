...
class Apple_Pay_Domain(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Apple_Pay_Domain(created={created!r}, domain_name={domain_name!r}, id={id!r}, livemode={livemode!r}, object={object!r})'.format(created=self.created, domain_name=self.domain_name, id=self.id, livemode=self.livemode, object=self.object)
