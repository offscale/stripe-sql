...
class PaymentMethodOptionsBoleto(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "PaymentMethodOptionsBoleto(expires_after_days={expires_after_days!r}, setup_future_usage={setup_future_usage!r}, id={id!r})".format(
