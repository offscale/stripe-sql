...
class Payment_Method_Details_Sepa_Credit_Transfer(Base):
    ...
    iban = Column(String, comment='IBAN of the bank account to transfer funds to', nullable=True)
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Method_Details_Sepa_Credit_Transfer(bank_name={bank_name!r}, bic={bic!r}, iban={iban!r})'.format(bank_name=self.bank_name, bic=self.bic, iban=self.iban)
