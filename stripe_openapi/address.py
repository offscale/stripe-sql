...
class Address(Base):
    ...
    city = Column(
        String, comment="City, district, suburb, town, or village", nullable=True
    )
    country = Column(
        String,
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "Address(city={city!r}, country={country!r}, line1={line1!r}, line2={line2!r}, postal_code={postal_code!r}, state={state!r}, id={id!r})".format(
            city=self.city,
