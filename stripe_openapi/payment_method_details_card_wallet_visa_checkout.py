...
class PaymentMethodDetailsCardWalletVisaCheckout(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "PaymentMethodDetailsCardWalletVisaCheckout(billing_address={billing_address!r}, email={email!r}, name={name!r}, shipping_address={shipping_address!r}, id={id!r})".format(
