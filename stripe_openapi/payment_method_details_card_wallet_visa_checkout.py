...
PaymentMethodDetailsCardWalletVisaCheckout.Json = Table(
    "payment_method_details_card_wallet_visa_checkout.json",
    metadata,
    Column(
        "billing_address",
        Address,
...
__all__ = ["payment_method_details_card_wallet_visa_checkout.json"]
