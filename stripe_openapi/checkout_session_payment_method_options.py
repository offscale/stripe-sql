...
class Checkout_Session_Payment_Method_Options(Base):
    ...
    afterpay_clearpay = Column(CheckoutAfterpayClearpayPaymentMethodOptions, nullable=True)
    ...
    customer_balance = Column(CheckoutCustomerBalancePaymentMethodOptions, nullable=True)
