...
CheckoutAcssDebitPaymentMethodOptions.Json = Table(
    "checkout_acss_debit_payment_method_options.json",
    metadata,
    Column(
        "currency",
        String,
    ...
    Column(
        ...
        ForeignKey("CheckoutAcssDebitMandateOptions"),
        nullable=True,
    ),
    Column(
        "setup_future_usage",
...
__all__ = ["checkout_acss_debit_payment_method_options.json"]
