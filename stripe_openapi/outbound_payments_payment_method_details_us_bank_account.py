...
class Outbound_Payments_Payment_Method_Details_Us_Bank_Account(Base):
    __tablename__ = 'outbound_payments_payment_method_details_us_bank_account'
    ...
    network = Column(String, comment='The US bank account network used to send funds')
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Outbound_Payments_Payment_Method_Details_Us_Bank_Account(account_holder_type={account_holder_type!r}, account_type={account_type!r}, bank_name={bank_name!r}, fingerprint={fingerprint!r}, last4={last4!r}, network={network!r}, routing_number={routing_number!r})'.format(account_holder_type=self.account_holder_type, account_type=self.account_type, bank_name=self.bank_name, fingerprint=self.fingerprint, last4=self.last4, network=self.network, routing_number=self.routing_number)
__all__ = ['outbound_payments_payment_method_details_us_bank_account']