...
OutboundPaymentsPaymentMethodDetailsUsBankAccount.Json = Table(
    "outbound_payments_payment_method_details_us_bank_account.json",
    metadata,
    Column(
        "account_holder_type",
        String,
...
__all__ = ["outbound_payments_payment_method_details_us_bank_account.json"]
