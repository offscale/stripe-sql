...
class Payment_Intent_Next_Action_Card_Await_Notification(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "Payment_Intent_Next_Action_Card_Await_Notification(charge_attempt_at={charge_attempt_at!r}, customer_approval_required={customer_approval_required!r}, id={id!r})".format(
