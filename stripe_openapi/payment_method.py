...
class Payment_Method(Base):
    ...
    customer = Column(Customer, comment='The ID of the Customer to which this PaymentMethod is saved. This will not be set when the PaymentMethod has not been saved to a Customer', nullable=True)
    ...
    type = Column(String, comment='The type of the PaymentMethod. An additional hash is included on the PaymentMethod with a name matching this value. It contains additional information specific to the PaymentMethod type')
