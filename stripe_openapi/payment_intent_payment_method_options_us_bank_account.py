...
class Payment_Intent_Payment_Method_Options_Us_Bank_Account(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Intent_Payment_Method_Options_Us_Bank_Account(financial_connections={financial_connections!r}, setup_future_usage={setup_future_usage!r}, verification_method={verification_method!r}, id={id!r})'.format(financial_connections=self.financial_connections, setup_future_usage=self.setup_future_usage, verification_method=self.verification_method, id=self.id)
