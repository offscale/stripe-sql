...
PaymentIntentPaymentMethodOptionsUsBankAccount.Json = Table(
    "payment_intent_payment_method_options_us_bank_account.json",
    metadata,
    Column(
...
__all__ = ["payment_intent_payment_method_options_us_bank_account.json"]
