...
class Checkout_Oxxo_Payment_Method_Options(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Checkout_Oxxo_Payment_Method_Options(expires_after_days={expires_after_days!r}, setup_future_usage={setup_future_usage!r}, id={id!r})'.format(expires_after_days=self.expires_after_days, setup_future_usage=self.setup_future_usage, id=self.id)
