...
class Mandate_Options_Off_Session_Details_Blik(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "Mandate_Options_Off_Session_Details_Blik(amount={amount!r}, currency={currency!r}, interval={interval!r}, interval_count={interval_count!r}, id={id!r})".format(
            amount=self.amount,
