...
class Payment_Intent_Payment_Method_Options_Acss_Debit(Base):
    ...
    mandate_options = Column(PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit, nullable=True)
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Intent_Payment_Method_Options_Acss_Debit(mandate_options={mandate_options!r}, setup_future_usage={setup_future_usage!r}, verification_method={verification_method!r}, id={id!r})'.format(mandate_options=self.mandate_options, setup_future_usage=self.setup_future_usage, verification_method=self.verification_method, id=self.id)
__all__ = ['payment_intent_payment_method_options_acss_debit']