...
class PaymentIntentPaymentMethodOptionsAuBecsDebit(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "PaymentIntentPaymentMethodOptionsAuBecsDebit(setup_future_usage={setup_future_usage!r}, id={id!r})".format(
