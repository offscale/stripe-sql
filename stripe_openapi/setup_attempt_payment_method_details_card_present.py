...
class Setup_Attempt_Payment_Method_Details_Card_Present(Base):
    ...
    generated_card = Column(
        payment_method,
        comment="[[FK(payment_method)]] The ID of the Card PaymentMethod which was generated by this SetupAttempt",
        nullable=True,
    )
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "Setup_Attempt_Payment_Method_Details_Card_Present(generated_card={generated_card!r}, id={id!r})".format(
