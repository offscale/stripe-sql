...
class Payment_Method_Details_Us_Bank_Account(Base):
    __tablename__ = 'payment_method_details_us_bank_account'
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Method_Details_Us_Bank_Account(account_holder_type={account_holder_type!r}, account_type={account_type!r}, bank_name={bank_name!r}, fingerprint={fingerprint!r}, last4={last4!r}, routing_number={routing_number!r})'.format(account_holder_type=self.account_holder_type, account_type=self.account_type, bank_name=self.bank_name, fingerprint=self.fingerprint, last4=self.last4, routing_number=self.routing_number)
__all__ = ['payment_method_details_us_bank_account']