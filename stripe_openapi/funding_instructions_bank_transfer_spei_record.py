...
class Funding_Instructions_Bank_Transfer_Spei_Record(Base):
    ...
    bank_name = Column(String, comment='The short banking institution name', primary_key=True)
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Funding_Instructions_Bank_Transfer_Spei_Record(bank_code={bank_code!r}, bank_name={bank_name!r}, clabe={clabe!r})'.format(bank_code=self.bank_code, bank_name=self.bank_name, clabe=self.clabe)
