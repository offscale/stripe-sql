...
PaymentMethodOptionsCustomerBalance.Json = Table(
    "payment_method_options_customer_balance.json",
    metadata,
    Column(
        "bank_transfer",
        PaymentMethodOptionsCustomerBalanceBankTransfer,
        ForeignKey("PaymentMethodOptionsCustomerBalanceBankTransfer"),
        nullable=True,
    ),
    Column(
        "funding_type",
...
__all__ = ["payment_method_options_customer_balance.json"]
