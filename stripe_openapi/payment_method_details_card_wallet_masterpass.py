...
class Payment_Method_Details_Card_Wallet_Masterpass(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "Payment_Method_Details_Card_Wallet_Masterpass(billing_address={billing_address!r}, email={email!r}, name={name!r}, shipping_address={shipping_address!r}, id={id!r})".format(
