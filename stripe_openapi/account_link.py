...
class Account_Link(Base):
    ...
    expires_at = Column(Integer, comment='The timestamp at which this account link will expire')
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Account_Link(created={created!r}, expires_at={expires_at!r}, object={object!r}, url={url!r}, id={id!r})'.format(created=self.created, expires_at=self.expires_at, object=self.object, url=self.url, id=self.id)
