...
class PaymentPagesCheckoutSessionShippingAddressCollection(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "PaymentPagesCheckoutSessionShippingAddressCollection(allowed_countries={allowed_countries!r}, id={id!r})".format(
