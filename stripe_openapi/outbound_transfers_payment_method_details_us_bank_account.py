...
class Outbound_Transfers_Payment_Method_Details_Us_Bank_Account(Base):
    __tablename__ = 'outbound_transfers_payment_method_details_us_bank_account'
