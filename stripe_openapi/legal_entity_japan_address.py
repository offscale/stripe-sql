...
class Legal_Entity_Japan_Address(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Legal_Entity_Japan_Address(city={city!r}, country={country!r}, line1={line1!r}, line2={line2!r}, postal_code={postal_code!r}, state={state!r}, town={town!r}, id={id!r})'.format(city=self.city, country=self.country, line1=self.line1, line2=self.line2, postal_code=self.postal_code, state=self.state, town=self.town, id=self.id)
