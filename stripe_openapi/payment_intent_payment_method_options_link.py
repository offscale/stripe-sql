...
PaymentIntentPaymentMethodOptionsLink.Json = Table(
    "payment_intent_payment_method_options_link.json",
    metadata,
    Column(
        "capture_method",
        String,
...
__all__ = ["payment_intent_payment_method_options_link.json"]
