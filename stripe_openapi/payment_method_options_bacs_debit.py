...
class Payment_Method_Options_Bacs_Debit(Base):
    __tablename__ = 'payment_method_options_bacs_debit'
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Payment_Method_Options_Bacs_Debit(setup_future_usage={setup_future_usage!r}, id={id!r})'.format(setup_future_usage=self.setup_future_usage, id=self.id)
__all__ = ['payment_method_options_bacs_debit']