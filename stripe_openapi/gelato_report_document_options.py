...
class GelatoReportDocumentOptions(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return "GelatoReportDocumentOptions(allowed_types={allowed_types!r}, require_id_number={require_id_number!r}, require_live_capture={require_live_capture!r}, require_matching_selfie={require_matching_selfie!r})".format(
