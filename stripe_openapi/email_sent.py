...
class Email_Sent(Base):
    ...
    def __repr__(self):
        ...
        :rtype: ```str```
        """
        return 'Email_Sent(email_sent_at={email_sent_at!r}, email_sent_to={email_sent_to!r}, id={id!r})'.format(email_sent_at=self.email_sent_at, email_sent_to=self.email_sent_to, id=self.id)
__all__ = ['email_sent']